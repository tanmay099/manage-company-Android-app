...
//sulution 4 showing about us page to the user used an external library for better and clean view
public class About extends AppCompatActivity {
    ...
    Element getCopyRightsElement() {
        ...
        copyRightsElement.setIconDrawable(R.drawable.ic_password);
